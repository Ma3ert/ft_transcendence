...
const UserSetting = (props: Props) => {
  ...
  console.log("current user from the user setting: ", currentUser);
  ...
  return (
    <form onSubmit={handleSubmit}>
      <Stack py={"15%"} align={"center"} spacing={"6%"} w={{ base: "225px", md: "335px", lg: "465px"}} maxH={"100%"} bg={"#1D222C"} px={{base: "25px", md: "45px" }} borderRadius={"20px"}>
