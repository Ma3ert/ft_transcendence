...
const UserSetting = (props: Props) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <Stack justifyContent={"center"} w={"100%"} h={"60vh"} bg={"#1D222C"} px={{base: "25px", md: "45px" }} borderRadius={"20px"}>
        <Stack spacing={{ base: "20px", md: "25px" }} align={"center"}>
          ...
          <Wrap align={"end"} position={"relative"}>
            <Avatar zIndex={0} boxSize={{base: "80px", md: "100px", xl: "137px" }} src={newAvatar}></Avatar>
            <Box
              as='label'
              htmlFor='avatar'
              zIndex={1}
