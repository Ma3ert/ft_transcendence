    ...
    return (
        ...
        >
            <HStack justifyContent="flex-start">
                <Avatar src={user.avatar} border="1px solid #D9D9D9"/>
            ...
            <HStack>
                <Avatar src={opponent.avatar.includes("http") ? opponent.avatar : "http://e1r9p5.1337.ma:3000/public/users/imgs/" + opponent.avatar} border="1px solid #D9D9D9" />
                <VStack alignItems="flex-start" gap={1} width="120px">
