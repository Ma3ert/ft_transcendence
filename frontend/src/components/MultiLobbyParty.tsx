  ...
  return (
    <Wrap align={"center"}>
        <Stack align={"center"} spacing={"10px"} style={{ position: 'absolute', zIndex: 1 }} >
            ...
            <Image src='/firstRaquette.png' w={{base: "200px", lg: "230px", "2xl": "390px" }} h={"auto"}></Image>
        </Stack>
        <Stack align={"center"} spacing={"10px"} style={{ position: 'relative', zIndex: 0 }} marginLeft={{ base: "90px", lg: "130px", "2xl": "180px" }}>
            ...
            { alone
                ? <Image src='/secondRacketSh.png'  w={{base: "200px", lg: "230px", "2xl": "390px" }} h={"auto"}></Image>
                : <Image src='/secondRaquette.png' w={{base: "200px", lg: "230px", "2xl": "390px" }} h={"auto"}></Image>
            }
        </Stack>
    </Wrap>
  )
